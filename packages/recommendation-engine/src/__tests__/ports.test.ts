...
const TEST_PROFILE: ConfirmedProfile = {
  ...
  family_occupation: { traditional_caste_occupation: 'weaving', family_members_in_trade: 2, years_practiced: 10 },
  current_livelihood: { primary_source: 'daily_wage', approximate_monthly_income_inr: 4000, is_seasonal: true },
  skills_and_interests: { existing_skills: ['hand_stitching'], aspired_livelihood: 'tailoring', interested_sectors: ['Apparel'] },
  ...
  local_economic_context: { prominent_local_trades: ['garments'] },
